...
?>
<div id='div_resetRTSPAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_RTSPreset' style='overflow: auto; height: 90%;with:90%;'></pre>
...
<script>
	$.ajax({
		...
		error: function (request, status, error) {
			handleAjaxError(request, status, error, $('#div_resetRTSPAlert'));
		},
		success: function () {
			 jeedom.log.autoupdate({
			       log : 'RTSP_reset',
			       display : $('#pre_RTSPreset'),
