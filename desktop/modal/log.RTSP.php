...
?>
<div id='div_logRTSPAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_RTSPlog' style='overflow: auto; height: 90%;with:90%;'></pre>
...
<script>
	$.ajax({
		...
		error: function (request, log, error) {
			handleAjaxError(request, log, error, $('#div_logRTSPAlert'));
		},
		success: function () {
