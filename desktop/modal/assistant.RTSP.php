...
?>
<div id='div_assisantRTSPAlert' style="display: none;"></div>
...
<div id="contentAssistant" style="height: 100%">
	<iframe id="docIspyConnect" src="https://www.ispyconnect.com/sources.aspx" height="100%" width="100%">
	  <p>Votre navigateur ne supporte pas l'élément iframe</p>
	</iframe>
</div>
<script type="text/javascript" src="/plugins/RTSP/3rdparty/hilitor.js"></script>
<script>
	$("#go").click(function(){
